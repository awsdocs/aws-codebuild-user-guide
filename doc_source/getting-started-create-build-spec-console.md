# Step 2: Create the buildspec file<a name="getting-started-create-build-spec-console"></a>

\(Previous step: [Step 1: Create the source code](getting-started-create-source-code-console.md)\)
