...
1. To change information about the source code location, in **Source: What to build**, choose **Update source**\. Use the following table to make selections appropriate for your source provider:  
****    
