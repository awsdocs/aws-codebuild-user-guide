...
| --- | --- | --- | --- | --- | --- | 
| Ubuntu 14\.04 | \(Base image\) |  | AWS CLI, Git 1\.9\.1, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/ubuntu\-base:14\.04 | [ubuntu/ubuntu\-base/14\.04](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/ubuntu-base/14.04) | 
| Ubuntu 14\.04 | Android | 24\.4\.1 | AWS CLI, Git 1\.9\.1, Java 8, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/android\-java\-8:24\.4\.1 | [ubuntu/android\-java\-8/24\.4\.1](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/android-java-8/24.4.1) | 
| Ubuntu 14\.04 | Docker | 17\.09\.0 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/docker:17\.09\.0 | [ubuntu/docker/17\.09\.0](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/docker/17.09.0) | 
| Ubuntu 14\.04 | Golang | 1\.7\.3 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/golang:1\.7\.3 | [ubuntu/golang/1\.7\.3](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/golang/1.7.3) | 
| Ubuntu 14\.04 | Java | 8 | Apache Ant 1\.9\.6, Apache Maven 3\.3\.3, AWS CLI, Git 1\.9\.1, Gradle 2\.7, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/java:openjdk\-8 | [ubuntu/java/openjdk\-8](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/java/openjdk-8) | 
| Ubuntu 14\.04 | Node\.js | 6\.3\.1 | AWS CLI, Git 1\.9\.1, NPM, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/nodejs:6\.3\.1 | [ubuntu/nodejs/6\.3\.1](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/nodejs/6.3.1) | 
| Ubuntu 14\.04 | Node\.js | 4\.4\.7 | AWS CLI, Git 1\.9\.1, NPM, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/nodejs:4\.4\.7 | [ubuntu/nodejs/4\.4\.7](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/nodejs/4.4.7) | 
| Ubuntu 14\.04 | Node\.js | 4\.3\.2 | AWS CLI, Git 1\.9\.1, NPM, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/nodejs:4\.3\.2 | [ubuntu/nodejs/4\.3\.2](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/nodejs/4.3.2) | 
| Ubuntu 14\.04 | Python | 3\.5\.2 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/python:3\.5\.2 | [ubuntu/python/3\.5\.2](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/python/3.5.2) | 
| Ubuntu 14\.04 | Python | 3\.4\.5 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/python:3\.4\.5 | [ubuntu/python/3\.4\.5](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/python/3.4.5) | 
| Ubuntu 14\.04 | Python | 3\.3\.6 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/python:3\.3\.6 | [ubuntu/python/3\.3\.6](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/python/3.3.6) | 
| Ubuntu 14\.04 | Python | 2\.7\.12 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/python:2\.7\.12 | [ubuntu/python/2\.7\.12](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/python/2.7.12) | 
| Ubuntu 14\.04 | Ruby | 2\.3\.1 | AWS CLI, Bundler 1\.13\.5, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, RubyGems 2\.6\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/ruby:2\.3\.1 | [ubuntu/ruby/2\.3\.1](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/ruby/2.3.1) | 
| Ubuntu 14\.04 | Ruby | 2\.2\.5 | AWS CLI, Bundler 1\.13\.5, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, RubyGems 2\.6\.7, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/ruby:2\.2\.5 | [ubuntu/ruby/2\.2\.5](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/ruby/2.2.5) | 
| Ubuntu 14\.04 | \.NET Core | 1\.1 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, \.NET Core SDK 1\.0\.4, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/dot\-net:core\-1 | [ubuntu/dot\-net/core\-1](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/dot-net/core-1) | 
| Ubuntu 14\.04 | \.NET Core | 2\.0 | AWS CLI, Git 1\.9\.1, pip 8\.1\.2, Python 2\.7, \.NET Core SDK 2\.0\.3, Docker 17\.09\.0 and Docker Compose 1\.16\.1 | aws/codebuild/dot\-net:core\-2\.0 | [ubuntu/dot\-net/core\-2](https://github.com/aws/aws-codebuild-docker-images/tree/master/ubuntu/dot-net/core-2) | 
