# Step 4: Upload the Source Code and the Build Spec<a name="getting-started-cli-upload-source-code"></a>

\(Previous step: [Step 3: Create the Build Spec](getting-started-cli-create-build-spec.md)\)
...
## Next Step<a name="getting-started-cli-upload-source-code-next"></a>
